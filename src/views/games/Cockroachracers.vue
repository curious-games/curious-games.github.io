    ...
    <div class="container relative px-4 py-10 mx-auto text-black md:px-0">
      <div class="grid grid-cols-6 gap-4 auto-cols-max">
        ...
        <div class="col-span-6 md:col-span-3 md:col-start-2">
          ...
          <p class="mb-4">Prepare yourself for the worlds first photorealistic rendered cock roach race contest. Pick your roach and watch them compete to finish line glory (well for the roaches, that make it of course!).<br>The virtual race is live rendered with digital 3D action and RNG based. </p>
