<template>
  <div class="w-screen mx-auto scroll-container">
    <section class="w-screen scroll-sequence__container show-one-container">
      <div class="sticky inset-0 h-screen bg-center bg-no-repeat bg-cover -z-5 scroll-sequence show-one-sequence"></div>
    ...
    <section class="scroll-sequence__container show-two-container">
      <div class="sticky inset-0 h-screen bg-center bg-no-repeat bg-cover -z-5 scroll-sequence show-two-sequence"></div>
      <div class="max-w-full p-16 text-white scroll-sequence__content">
        <div class="grid mx-0 -mt-half mb-mega floater place-content-start">
          <div class="max-w-md pt-4 border-t-2 border-gradient-r-curious">
            <p class="text-xl font-bold">Home 01 We push boundaries every day to entertain and maximize the gaming experience for players</p>
    ...
    <section class="scroll-sequence__container show-three-container">
      <div class="sticky inset-0 h-screen bg-center bg-no-repeat bg-cover -z-5 scroll-sequence show-three-sequence"></div>
      <div class="max-w-full p-16 text-white scroll-sequence__content">
        <div class="grid mx-0 -mt-half mb-mega floater place-content-start">
          <div class="max-w-md pt-4 border-t-2 border-gradient-r-curious">
            <p class="text-xl font-bold">Home 01 We push boundaries every day to entertain and maximize the gaming experience for players</p>
...
// import Carousel from "@/components/Carousel.vue";
  ...
  export default {
    ...
    mounted() {
      ...
      const showOneSequenceImages = [];
      const showTwoSequenceImages = [];
      const showThreeSequenceImages = [];

      for (let i = 0; i <= 131; i ++) {
        showOneSequenceImages.push(`${`000${i}`.slice(-4)}.jpg`);
      }

      for (let i = 0; i <= 131; i ++) {
        showTwoSequenceImages.push(`${`000${i}`.slice(-4)}.jpg`);
      }

      for (let i = 0; i <= 131; i ++) {
        showThreeSequenceImages.push(`${`000${i}`.slice(-4)}.jpg`);
      }
      ...
      */
      ...
      const showOneSequence = new ScrollSequence({
        container: '.show-one-sequence',
        scrollWith: '.show-one-container',
        images: showOneSequenceImages,
      ...
      const showTwoSequence = new ScrollSequence({
        container: '.show-two-sequence',
        scrollWith: '.show-two-container',
        images: showTwoSequenceImages,
      ...
      const showThreeSequence = new ScrollSequence({
        container: '.show-three-sequence',
        scrollWith: '.show-three-container',
        images: showThreeSequenceImages,
      ...
      const showNullSequence = new ScrollSequence({
